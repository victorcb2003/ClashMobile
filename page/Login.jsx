        ...
        <>
            <View className="relative h-screen w-full overflow-hidden">
                ...
                <View className="relative z-10 h-full flex justify-center items-center">
                    <View className="w-[360px] shadow-lg px-10 py-8 rounded-xl flex flex-col justify-center backdrop-blur-md text-green-50 gap-4" style={{ backgroundColor: "hsla(130, 10%, 15%, 0.45)" }} >
                        ...
                        <View className="flex flex-col justify-center gap-2 w-full">
                            <Text className="text-md font-medium">Mot de passe</Text>
                            <TextInput
                                type="password"
                                required
                                name="password"
                        ...
                        <View className="w-full flex justify-end">
                            <Pressable type="submit" className="px-4 py-2 rounded-md bg-green-800 text-white hover:bg-green-700 transition-all" >Se connecter</Pressable>
                        </View>
